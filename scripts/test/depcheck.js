...
const _logDepcheckResults = results => {
  console.log(results.dependencies); // an array containing the unused dependencies
  console.log(results.devDependencies); // an array containing the unused devDependencies
